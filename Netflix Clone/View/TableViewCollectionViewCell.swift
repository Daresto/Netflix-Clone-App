...
class TableViewCollectionViewCell: UITableViewCell {
    ...
    static let identifier = "TableViewCollectionViewCell"
...
extension TableViewCollectionViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName + " trailer") { [weak self] result in
            ...
            case .success(let videoElement):
                ...
                self?.delegate?.tableViewCollectionViewCell(strongSelf, viewModel: viewModel)
